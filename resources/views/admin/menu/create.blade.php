...
<body class="flex h-screen bg-yellow-50 text-gray-800 font-sans">
  ...
  <aside class="w-64 bg-white border-r border-gray-200 flex flex-col">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        ...
        <a href="{{ route('admin.menu.index') }}" class="flex items-center px-4 py-2 bg-yellow-500 rounded-lg font-medium">
  ...
  <div class="flex-1 flex flex-col overflow-hidden">
    ...
    <header class="flex justify-between items-center px-8 py-5  bg-white border-b border-grey-200">
      ...
      <a href="{{ route('admin.menu.index') }}" class="inline-flex items-center gap-2 px-5 py-2 bg-yellow-500 text-white font-semibold rounded-lg shadow hover:bg-yellow-600 transition">
        ...
        <form action="{{ route('admin.menu.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="grid grid-cols-2 gap-6">
            ...
            <div class="flex flex-col">
              ...
              <div class="flex items-center border border-yellow-200 rounded-xl mt-2 focus-within:ring-2 focus-within:ring-yellow-400">
                ...
                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required class="w-full px-4 py-3 border-0 rounded-xl focus:outline-none" />
              </div>
              @error('nama')
            ...
            <div class="flex flex-col">
              ...
              <div class="flex items-center border border-yellow-200 rounded-xl mt-2 focus-within:ring-2 focus-within:ring-yellow-400">
                ...
                <input type="number" name="harga" id="harga" value="{{ old('harga') }}" required class="w-full px-4 py-3 border-0 rounded-xl focus:outline-none" />
              </div>
              @error('harga')
                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
              @enderror
          ...
          <div class="grid grid-cols-2 gap-6 mt-6">
            ...
            <div class="flex flex-col">
              ...
              <div class="flex items-center border border-yellow-200 rounded-xl mt-2 focus-within:ring-2 focus-within:ring-yellow-400">
                ...
                <input type="text" name="kategori" id="kategori" value="{{ old('kategori') }}" required class="w-full px-4 py-3 border-0 rounded-xl focus:outline-none" />
              </div>
              @error('kategori')
                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
              @enderror
            ...
            <div class="flex flex-col">
              ...
              <div class="flex items-center border border-yellow-200 rounded-xl mt-2 focus-within:ring-2 focus-within:ring-yellow-400">
                ...
                <input type="file" name="gambar" id="gambar" class="w-full px-4 py-3 border-0 rounded-xl focus:outline-none" />
              </div>
              @error('gambar')
                <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
              @enderror
          ...
          <div class="flex flex-col mt-6">
            ...
            <div class="flex items-start border border-yellow-200 rounded-xl mt-2 focus-within:ring-2 focus-within:ring-yellow-400">
              ...
              <textarea name="deskripsi" id="deskripsi" rows="4" class="w-full px-4 py-3 border-0 rounded-xl focus:outline-none">{{ old('deskripsi') }}</textarea>
            </div>
            @error('deskripsi')
              <div class="text-red-500 text-xs mt-1">{{ $message }}</div>
            @enderror
